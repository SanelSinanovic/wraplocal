        ...
        <div className="pricing-pad" style={{ maxWidth: 900, margin: "0 auto", padding: "80px 40px", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, textAlign: "left", maxWidth: 700, margin: "0 auto 60px" }}>
            <div className="price-card pricing-card-1" style={{ background: "#111", border: "1px solid rgba(255,255,255,0.08)", padding: "36px 32px" }}>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "rgba(255,255,255,0.3)", letterSpacing: 2, marginBottom: 16, textTransform: "uppercase" }}>Monthly Listing</div>
              <div style={{ fontSize: 56, color: "#fff", marginBottom: 4 }}>$49<span style={{ fontSize: 24, color: "rgba(255,255,255,0.5)" }}>.99</span></div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.3)", marginBottom: 28 }}>per month + 7% per booking</div>
            ...
            <div className="price-card featured pricing-card-2" style={{ background: "linear-gradient(135deg, rgba(255,77,0,0.1) 0%, rgba(255,140,0,0.04) 60%, #111 100%)", border: "1px solid rgba(255,77,0,0.3)", padding: "36px 32px", position: "relative" }}>
              <div style={{ position: "absolute", top: -12, right: 20, background: "#FF4D00", padding: "4px 14px", fontFamily: "'DM Sans', sans-serif", fontSize: 10, letterSpacing: 2, textTransform: "uppercase" }}>Popular</div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "rgba(255,160,80,0.6)", letterSpacing: 2, marginBottom: 16, textTransform: "uppercase" }}>Annual Listing</div>
              <div style={{ fontSize: 56, color: "#fff", marginBottom: 4 }}>$39<span style={{ fontSize: 24, color: "rgba(255,255,255,0.5)" }}>.99</span></div>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "rgba(255,200,100,0.45)", marginBottom: 28 }}>per month · billed $479.88/yr + 7% per booking</div>
