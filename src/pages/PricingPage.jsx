    ...
    <div style={{ fontFamily: "'Bebas Neue', cursive", background: "linear-gradient(180deg, #0A0A0A 0%, #140A04 20%, #0A0A0A 55%, #05050C 100%)", minHeight: "100vh", color: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="pricing-pad" style={{ maxWidth: 900, margin: "0 auto", padding: "80px 40px", textAlign: "center", position: "relative", zIndex: 1 }}>
          {/* Ambient orbs */}
          <div aria-hidden="true" style={{ position: "fixed", top: "-10%", right: "-8%", width: 650, height: 650, background: "radial-gradient(circle, rgba(255,77,0,0.2) 0%, transparent 65%)", borderRadius: "50%", pointerEvents: "none", animation: "glow-breathe 6s ease-in-out infinite", zIndex: 0 }} />
          <div aria-hidden="true" style={{ position: "fixed", bottom: "-10%", left: "-5%", width: 550, height: 550, background: "radial-gradient(circle, rgba(59,130,246,0.15) 0%, transparent 65%)", borderRadius: "50%", pointerEvents: "none", animation: "orb-drift 14s ease-in-out infinite", zIndex: 0 }} />
          ...
          <div className="pricing-footer" style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.25)" }}>
            Questions? Email <a href="mailto:partners@wrapbridge.com" style={{ color: "#FF4D00" }}>partners@wrapbridge.com</a>
          </div>
        </div>
      </div>
    </div>
