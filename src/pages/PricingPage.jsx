  ...
  return (
    <div style={{ fontFamily: "'Bebas Neue', cursive", background: "#0A0A0A", minHeight: "100vh", color: "#fff" }}>
      ...
      <div className="pricing-pad" style={{ maxWidth: 900, margin: "0 auto", padding: "80px 40px", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: "rgba(255,255,255,0.5)", maxWidth: 500, margin: "0 auto 60px", lineHeight: 1.6 }}>Get listed on Kidor and reach thousands of local customers actively looking for wrap services.</p>
        ...
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.3)" }}>
          Questions? Email <span style={{ color: "#FF4D00" }}>partners@kidor.com</span>
        </div>
      </div>
    </div>
  );
