  ...
  return (
    <div style={{ fontFamily: "'Bebas Neue', cursive", background: "#0A0A0A", minHeight: "100vh", color: "#fff" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "80px 40px", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, textAlign: "left", maxWidth: 700, margin: "0 auto 60px" }}>
