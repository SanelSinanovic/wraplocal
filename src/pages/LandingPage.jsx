    ...
    <div style={{ fontFamily: "'Bebas Neue', cursive, sans-serif", background: "linear-gradient(180deg, #0A0A0A 0%, #140A04 20%, #0A0A0A 50%, #05050C 100%)", minHeight: "100vh", color: "#fff", overflow: "hidden" }}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "32px 60px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.3)", display: "flex", gap: 24, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button className="link-button" onClick={() => nav("accessibility")} style={{ color: "rgba(255,255,255,0.68)", cursor: "pointer", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color="#FF8C33"} onMouseLeave={e => e.currentTarget.style.color="rgba(255,255,255,0.68)"}>Accessibility</button>
