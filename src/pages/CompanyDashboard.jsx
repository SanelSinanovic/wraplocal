          ...
          <div style={{ maxWidth: 600 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <div>
                ...
                <input name="address-line1" autoComplete="address-line1" placeholder="Street address  (e.g. 1234 Peachtree St NW)" value={profileForm.address} onChange={e => setProfileForm(f => ({ ...f, address: e.target.value }))} style={{ width: "100%", background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.1)", padding: "12px 16px", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontSize: 14, outline: "none", marginBottom: 8 }} />
                <div className="location-grid" style={{ display: "grid", gridTemplateColumns: "1fr 80px 120px", gap: 8 }}>
                  <input name="address-level2" autoComplete="address-level2" placeholder="City  (e.g. Atlanta)" value={profileForm.city} onChange={e => setProfileForm(f => ({ ...f, city: e.target.value }))} style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.1)", padding: "12px 16px", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontSize: 14, outline: "none" }} />
                  <input name="address-level1" autoComplete="address-level1" placeholder="State" maxLength={2} value={profileForm.state} onChange={e => setProfileForm(f => ({ ...f, state: e.target.value.toUpperCase() }))} style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.1)", padding: "12px 16px", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontSize: 14, outline: "none", textTransform: "uppercase" }} />
                  <input name="postal-code" autoComplete="postal-code" inputMode="numeric" placeholder="Zip code" value={profileForm.zip} onChange={e => setProfileForm(f => ({ ...f, zip: e.target.value }))} style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.1)", padding: "12px 16px", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontSize: 14, outline: "none" }} />
                </div>
