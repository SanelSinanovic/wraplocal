...
export default function CompanyLogin({ nav, loginForm, setLoginForm, loginError, setLoginError, handleLogin }) {
  ...
  const handleForgotPassword = async () => {
    ...
    await supabase.auth.resetPasswordForEmail(forgotEmail, { redirectTo: window.location.origin + "/#company-login" });
